...
impl Cloth {
    pub fn new(app_view: &AppSurface) -> Self {
        ...
        let group_constraints_buf = BufferObj::create_storage_buffer(
            &app_view.device,
            &particle_constraints,
            Some("group_constraints_buf"),
        );
        ...
        // let roll_shader =
        //     crate::util::shader::create_shader_module("pbd/cloth_roll_init", &app_view.device);
