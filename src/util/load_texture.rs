...
#[allow(dead_code)]
pub fn from_path(
    image_path: &str, app_view: &app_surface::AppSurface, usage: wgpu::TextureUsages,
...
fn load_from_path(
    path: PathBuf, set_to_grayscale: bool,
...
pub fn empty(
    device: &wgpu::Device, format: TextureFormat, extent: Extent3d,
    view_dimension: Option<wgpu::TextureViewDimension>, usage: Option<wgpu::TextureUsages>,
    ...
    let view_dimension =
        if let Some(vd) = view_dimension { vd } else { wgpu::TextureViewDimension::D2 };
